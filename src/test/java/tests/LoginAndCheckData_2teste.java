...
public class LoginAndCheckData_2teste extends BaseTest{
 ...
 */
        ...
        WebElement message1 = driver.findElement(By.cssSelector("#folderPaneDroppableContainer > div > div.e4_J1 > div > div > div:nth-child(1) > div"));
        softAssert.assertEquals(message1.getText(), "Inbox", "Test 1 - elementul nu exista, test invalid");
        Thread.sleep(1000);

        WebElement message2 = driver.findElement(By.cssSelector("#folderPaneDroppableContainer > div > div.e4_J1 > div > div > div:nth-child(3) > div"));
        softAssert.assertEquals(message2.getText(), "Junk Email", "Test 2 - elementul nu exista, test invalid");
        Thread.sleep(1000);

        WebElement message3 = driver.findElement(By.cssSelector("#folderPaneDroppableContainer > div > div.e4_J1 > div > div > div:nth-child(4) > div"));
        softAssert.assertEquals(message3.getText(), "Drafts", "Test 3 - elementul nu exista, test invalid");
        Thread.sleep(1000);

        WebElement message4 = driver.findElement(By.cssSelector("#folderPaneDroppableContainer > div > div.e4_J1 > div > div > div:nth-child(5) > div"));
        softAssert.assertEquals(message4.getText(), "Sent Items", "Test 4 - elementul nu exista, test invalid");
        Thread.sleep(1000);

        WebElement message5 = driver.findElement(By.cssSelector("#folderPaneDroppableContainer > div > div.e4_J1 > div > div > div:nth-child(6) > div"));
...
// Accesam calea către fișierul HTML unde dorim sa inseram valorile
        String filePath = "Raport_Teste1.html";
...
// Confirmam ca valorile au fost inserate in fisierul "Raport_Teste1"
 ...
 */
    ...
    @Test
    public void testLogInAdminVailidCredentiual1() {

// Accesam fisierul "Raport_Teste" si-l rulam pt a afisa in pagina Chrome valorile citite
        File html_file = new File("Raport_Teste1.html");
...
Pagina "file:///C:/Users/crist/IdeaProjects/Proiect_Final/Raport_Teste1.html" se inchide manual dupa vizualizare si verificare.
 */
